...
const appVersion = {
  ...
  version: "0.5.7",
  versionLabel: "v0.5.7",
  build: "openai-motion-lag-tolerance-2026-07-13"
};
...
const comparisonModels = {
  ...
  "openai-expert": {
    ...
    version: "0.5.0",
    versionLabel: "v0.5.0",
    algorithmBuild: "openai-phrase-motion-tolerance-2026-07-13",
    name: "OpenAI эксперт",
    title: "OpenAI эксперт",
    shortTitle: "8. OpenAI эксперт",
    description:
      "Серверная AI-модель: оценивает хореографическую фразу целиком, мягко относится к небольшому опережению/отставанию быстрых движений и пишет простым языком педагога."
  }
};
...
function buildOpenAiComparisonPayload({ leftScan, rightScan, sync, regions, leftAudio, mediaPipeSettings, local }) {
  return {
    ...
    scoringPolicy: {
      ...
      warning:
        "Если локальная метрика резко снижена из-за trajectory/микрошумов, смаза быстрых рук или небольшого фазового сдвига, но корпус, руки, ноги, амплитуда и ритм подтверждают тот же танец, итоговую оценку нужно делать ближе к человеческой визуальной оценке, а не к шумной метрике."
    },
    commentStyle: {
      goal:
