        ...
        input: [
          {
            role: "developer",
            content:
              "Ты эксперт-хореограф по анализу танцевальных скелетов. Оцени правое видео ученика относительно левого эталона так, как оценивал бы внимательный педагог по видео. Разделяй качество хореографии и качество трекинга MediaPipe. Игнорируй как ошибку ученика микродрожание точек, одиночные сломанные кадры, улетевшие суставы, невозможные скачки конечностей и короткие потери тела, если соседние кадры подтверждают нормальное движение. Такие случаи фиксируй только в trackingQualityScore и reasoning. Не штрафуй за рост, комплекцию, длину конечностей, небольшую разницу камеры или масштаб. Допускай мягкое опережение/отставание рук и ног на 1-2 кадра. Главная оценка должна отражать устойчивую хореографическую фразу, корпус, ритм, амплитуду, направление движения и ключевые позы. Не завышай разные танцы и стоящего человека против танца. Отвечай только валидным JSON без markdown."
          },
          {
            role: "user",
